...
lazy_static! {
    pub static ref EXTENSIONS: HashMap<String, String> = [
        ...
        (".eml".to_string(), "EML".to_string()),
        (".mbox".to_string(), "EML".to_string()),
        ...
        (".jinja".to_string(), "HTML+Django".to_string()),
        (".j2".to_string(), "HTML+Django".to_string()),
        (".jinja2".to_string(), "HTML+Django".to_string()),
        ...
        (".vader".to_string(), "Vim script".to_string()),
